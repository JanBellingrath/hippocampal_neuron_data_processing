...
government = Animal('/local2/Jan/Government/Government', 'fra')
...
def neuron_ids_for_specific_animal_and_subarea(area, animal):
    ...
    splitted_epoch_dataframe = divis.split_neuron_dataframe_informationally(task.make_epochs_dataframe(animals, corriander, conley, dave, dudley, bond, chapati, remy, egypt, government, frank), ['type'])
