...
def subdivision_run_sleep_rest_times_dict(speed_series, speed_threshold_sleep, length_no_pre_movement, epoch_type, awake_last_n_seconds):
    ...
    subdivised_by_behav_state_dict['sleeping run epoch'] = sleeping_series_run
    subdivised_by_behav_state_dict['resting run epoch'] = resting_series_run
    subdivised_by_behav_state_dict['running run epoch'] = running_series_run
    
    subdivised_by_behav_state_dict['sleeping rest epoch'] = sleeping_series_rest
    subdivised_by_behav_state_dict['resting rest epoch'] = resting_series_rest
    subdivised_by_behav_state_dict['awake rest epoch'] = awake_series_rest
    
    
    return pd.DataFrame(subdivised_by_behav_state_dict)
